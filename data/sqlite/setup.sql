...
CREATE TABLE `item`(
  ...
  `hire`        INT          DEFAULT '1', # 19录用 -1私有 0推送 1普通 2优质 3置顶
...
# 插入正常栏目：
########################################################################
INSERT INTO`item`(`kid`,`item`,`title`,`name`)VALUES('101117','1011','文职人员','news');
INSERT INTO`item`(`kid`,`item`,`title`,`name`)VALUES('10111701','101117','公开招考','news');
...
CREATE TABLE `user` (
  ...
  `css`         TEXT, # 17样式表位置
  `level`       INT          DEFAULT '1', # 18权限0游客1会员2实名7管理8设计
  `hire`        INT          DEFAULT '0', # 19录用 -1私有 0推送 1普通 2优质 3置顶
  `hide`        INT          DEFAULT '1', # 20隐藏0隐藏 1显示
...
# 插入会员
INSERT INTO`user`(`kid`,`account`,`password`,`title`,`level`)VALUES('1','guest','guest','游客','0');
INSERT INTO`user`(`kid`,`account`,`password`,`title`,`level`)VALUES('2','root','root-root','设计师','8');
INSERT INTO`user`(`kid`,`account`,`password`,`title`,`level`)VALUES('3','admin','admin-admin','管理员','7');
INSERT INTO`user`(`kid`,`account`,`password`,`title`,`level`)VALUES('4','QH0951','RLZY390119','管理员','7');
INSERT INTO`user`(`kid`,`account`,`password`,`title`,`level`)VALUES('5','guest5','guest','游客5','0');
INSERT INTO`user`(`kid`,`account`,`password`,`title`,`level`)VALUES('6','guest6','guest','游客6','0');
INSERT INTO`user`(`kid`,`account`,`password`,`title`,`level`)VALUES('7','guest7','guest','游客7','0');
INSERT INTO`user`(`kid`,`account`,`password`,`title`,`level`)VALUES('8','guest8','guest','游客8','0');
INSERT INTO`user`(`kid`,`account`,`password`,`title`,`level`)VALUES('9','guest9','guest','游客9','0');
INSERT INTO`user`(`kid`,`account`,`password`,`title`,`level`)VALUES('10','guest10','guest','游客10','0');
INSERT INTO`user`(`kid`,`account`,`password`,`title`,`level`)VALUES('11','admin','admin391262','管理员','7');
...
CREATE TABLE `news` (
    ...
    `sid`         INT          DEFAULT 0,
    `name`        CHAR(255)    DEFAULT 'news',
    `account`     CHAR(255)    DEFAULT 'guest', # 3帐号
    `title`       TEXT, # 4昵称，标题
    `ip`          TEXT, # 5发表IP  
    `password`    TEXT, # 6密码
    `item`        INT          DEFAULT '13', # 7栏目
    ...
    `datetime`    TIMESTAMP    DEFAULT (datetime('now', 'localtime')),
    `millisecond` INT          DEFAULT '0', # 23毫秒
    `user`        INTEGER      DEFAULT '1', # 24 作者的kid，默认为guest
    `source`      INTEGER      DEFAULT '0', # 25 被评论文章的kid
    `coment`      INT          DEFAULT '0', # 26评论数量
    `cite`        INT          DEFAULT '0', # 27转发数量
    `heat`        INT          DEFAULT '0', # 28粉丝数量 关注数量
    `score`       INT          DEFAULT '0', # 29会员积分
...
INSERT INTO`news`(`kid`,`item`,`title`,`user`,`hire`,`video`)VALUES('4','10','暂无视频新闻（勿删）','2','2','/module/js/AEV/1.flv');
